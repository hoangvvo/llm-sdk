...
type CompletionUsageCompletionTokensDetails struct {
	...
	// Text output tokens generated by audio-capable models.
...
type CompletionUsagePromptTokensDetails struct {
	...
	// Image input tokens processed by audio-capable models.
	ImageTokens *int `json:"image_tokens,omitempty"`
	// Text input tokens processed by audio-capable models.
	TextTokens *int `json:"text_tokens,omitempty"`
}
