...
- [`describe-image-url`: Describe image from URL](./examples/describe-image-url.ts)
- [`summarize-audio`: Summarize audio](./examples/summarize-audio.ts)
- [`summarize-file`: Summarize file](./examples/summarize-file.ts)
- [`summarize-file-url`: Summarize file from URL](./examples/summarize-file-url.ts)
- [`function-calling`: Function calling](./examples/tool-use.ts)
- [`tool-search`: Tool search](./examples/tool-search.ts)
- [`stream-tool-search`: Stream tool search](./examples/stream-tool-search.ts)
