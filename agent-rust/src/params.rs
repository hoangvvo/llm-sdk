use crate::{tool::IntoAgentTool, Agent, AgentTool, InstructionParam, Toolkit};
    ...
    TCtx: Send + Sync + 'static,
{
    ...
    /// Add a tool
    #[must_use]
    pub fn add_tool<T, TArg>(mut self, tool: T) -> Self
    where
        T: IntoAgentTool<TCtx, TArg>,
    {
        self.tools.push(tool.into_agent_tool());
        self
    }
