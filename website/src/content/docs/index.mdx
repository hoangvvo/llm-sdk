...
<CardGrid>
  <LinkCard
    ...
    description="Learn how to build agentic AI applications using llm-agent."
    href="/agent/"
  />
  <LinkCard
...
`llm-sdk` is a suite of libraries to interact with various Large Language Model (LLM) providers through a unified API and build agentic AI applications.
