...
It is inspired by the _MemGPT_ paper, which defines two memory types:
...
The examples below demonstrate a basic in‑memory core store and a placeholder archival search (ready to replace with a vector DB).
