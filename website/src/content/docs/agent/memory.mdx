...
The Memory pattern enables an agent to retain information learned from earlier interactions and use it later. It is inspired by the [_MemGPT_](https://research.memgpt.ai/) paper, which defines two memory types:
