...
import { extractGoAgentParamsTypes, extractRustAgentParamsTypes, extractTypescriptAgentParamsTypes } from "../../../utils/extract-types.ts";
...
- Model output options such as `modalities`, `reasoning`, and `audio`.
...
<Tabs>
  <TabItem label="TypeScript">
    <Code
      code={extractTypescriptAgentParamsTypes([
        "AgentParams",
      ])}
      lang="typescript"
      title="params.ts"
  ...
  <TabItem label="Rust">
    <Code
      code={extractRustAgentParamsTypes([
        "AgentParams",
      ])}
      lang="rust"
      title="params.rs"
  ...
  <TabItem label="Go">
    <Code
      code={extractGoAgentParamsTypes([
        "AgentParams",
      ])}
      lang="go"
      title="params.go"
