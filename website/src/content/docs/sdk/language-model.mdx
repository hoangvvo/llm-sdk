...
<Aside>
  ...
  `AssistantMessage`. The nested `call.type` discriminates client function
  calls from provider-hosted web search without combining two discriminators at
...
<Tabs>
  <TabItem label="TypeScript">
    <Code
      code={extractTypescriptTypes(["ToolCallPart", "ToolCall", "FunctionToolCall", "WebSearchToolCall", "WebSearchAction"])}
      lang="typescript"
      title="types.ts"
    />
  </TabItem>
  <TabItem label="Rust">
    <Code
      code={extractRustTypes(["ToolCallPart", "ToolCall", "FunctionToolCall", "WebSearchToolCall", "WebSearchAction"])}
      lang="rust"
      title="types.rs"
    />
  </TabItem>
  <TabItem label="Go">
    <Code
      code={extractGoTypes(["ToolCallPart", "ToolCall", "FunctionToolCall", "WebSearchToolCall", "WebSearchAction"])}
      lang="go"
      title="types.go"
    />
  </TabItem>
...
<Tabs>
  <TabItem label="TypeScript">
    <Code
      code={extractTypescriptTypes(["ToolResultPart", "ToolResult", "FunctionToolResult", "WebSearchToolResult", "WebSearchSource"])}
      lang="typescript"
      title="types.ts"
    />
  </TabItem>
  <TabItem label="Rust">
    <Code
      code={extractRustTypes(["ToolResultPart", "ToolResult", "FunctionToolResult", "WebSearchToolResult", "WebSearchSource"])}
      lang="rust"
      title="types.rs"
    />
  </TabItem>
  <TabItem label="Go">
    <Code
      code={extractGoTypes(["ToolResultPart", "ToolResult", "FunctionToolResult", "WebSearchToolResult", "WebSearchSource"])}
      lang="go"
      title="types.go"
    />
  </TabItem>
