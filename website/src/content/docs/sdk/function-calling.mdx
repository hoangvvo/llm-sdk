...
import goToolUseImageCode from "../../../../../sdk-go/examples/tool-use-image/main.go?raw";
import goToolUseCode from "../../../../../sdk-go/examples/tool-use/main.go?raw";
import jsToolUseImageCode from "../../../../../sdk-js/examples/tool-use-image.ts?raw";
import jsToolUseCode from "../../../../../sdk-js/examples/tool-use.ts?raw";
import rustToolUseImageCode from "../../../../../sdk-rust/examples/tool-use-image.rs?raw";
...
<Tabs>
  ...
  <TabItem label="Rust">
    <Code code={extractRustTypes(["Tool"])} lang="rust" title="types.rs" />
  </TabItem>
  <TabItem label="Go">
    <Code code={extractGoTypes(["Tool"])} lang="go" title="types.go" />
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="Go">
    <Code code={extractGoTypes(["ToolCallPart"])} lang="go" title="types.go" />
  </TabItem>
</Tabs>
...
For supported models, each `ToolResultPart` can return image parts in addition to text.

This pattern is useful when your application fetches, renders, or generates an image and you want the model to reason over it directly.

<Tabs>
  <TabItem label="TypeScript">
    <Code
      code={jsToolUseImageCode}
      lang="typescript"
      title="tool-use-image.ts"
    />
  </TabItem>
  <TabItem label="Rust">
    <Code code={rustToolUseImageCode} lang="rust" title="tool-use-image.rs" />
  </TabItem>
  <TabItem label="Go">
    <Code code={goToolUseImageCode} lang="go" title="main.go" />
  </TabItem>
</Tabs>
