...
func (t *ArtifactCreateTool) Description() string {
	return "Create a new document and return an instruction for the client to persist it"
}
...
func (t *ArtifactUpdateTool) Description() string {
	return "Replace document content and return an instruction for the client to persist changes"
}
...
func (t *ArtifactGetTool) Description() string {
	return "Fetch a document from the current client context"
}
...
func (t *ArtifactListTool) Description() string {
	return "List documents from the current client context"
}
