...
pub type StopConfigurationValueString = Option<String>;

pub type StopConfigurationValueArray = Option<Vec<String>>;
...
#[non_exhaustive]
#[serde(untagged)]
pub enum StopConfigurationValue {
    StopConfigurationValueString(StopConfigurationValueString),
    StopConfigurationValueArray(StopConfigurationValueArray),
    #[allow(dead_code)]
    #[serde(skip_serializing)]
    Unknown(Value),
}
...
/// Up to 4 sequences where the API will stop generating further tokens. The
/// returned text will not contain the stop sequence.
pub type StopConfiguration = Option<Option<StopConfigurationValue>>;
